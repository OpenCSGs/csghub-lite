...
const en: Record<string, string> = {
  ...
  "settings.directoryBrowserDesc": "Select an existing local directory for storing model files.",
  ...
  "settings.modelDirSaveFailed": "Failed to save the model directory.",
...
const zh: Record<string, string> = {
  ...
  "settings.directoryBrowserDesc": "选择一个已有的本地目录来存放模型文件。",
  ...
  "settings.home": "主目录",
  "settings.cancel": "取消",
  "settings.modelDirSaveFailed": "保存模型目录失败。",
