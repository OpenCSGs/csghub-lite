...
const en: Record<string, string> = {
  ...
  "aiApps.open": "Open",
  "aiApps.model": "Model",
  "aiApps.modelHint": "Choose the local or cloud model to launch this app with.",
  "aiApps.modelLoading": "Loading models...",
  "aiApps.modelDefault": "Use app default",
  "aiApps.modelSourceCloud": "Cloud",
  ...
  "settings.loggedOutDesc": "Sign in to OpenCSG and save an Access Token to use Cloud models.",
  ...
  "chat.cloud": "Cloud",
  "chat.cloudLoginTitle": "Login required for Cloud models",
  "chat.cloudLoginDesc": "Cloud models run on OpenCSG AI Space. Open the login page in your browser, then paste an Access Token here so csghub-lite can proxy requests securely.",
  ...
  "chat.cloudLoginRequired": "Cloud models require an OpenCSG login.",
...
const zh: Record<string, string> = {
  ...
  "aiApps.open": "打开",
  "aiApps.model": "模型",
  "aiApps.modelHint": "选择要用来启动该应用的本地或 Cloud 模型。",
  ...
  "settings.loggedOutDesc": "登录 OpenCSG 并保存 Access Token 后，才可以使用 Cloud 模型。",
  ...
  "chat.cloud": "Cloud",
  "chat.cloudLoginTitle": "Cloud 模型需要登录",
  "chat.cloudLoginDesc": "Cloud 模型运行在 OpenCSG AI Space。请先在浏览器中完成登录，再把 Access Token 粘贴到这里，csghub-lite 才能安全代理你的请求。",
  ...
  "chat.cloudLoginRequired": "使用 Cloud 模型前需要先登录 OpenCSG。",
  "chat.cloudLoginExpired": "Cloud 登录已失效，或当前 token 无效，请重新登录并更新 Access Token。",
