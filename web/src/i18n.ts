...
const en: Record<string, string> = {
  ...
  "aiApps.codexLoginHint": "If Codex asks you to sign in, the login link may appear earlier in the terminal output. Use this shortcut to jump back to it.",
  "aiApps.codexScrollTop": "Scroll to login prompt",
...
const zh: Record<string, string> = {
  ...
  "aiApps.codexLoginHint": "如果 Codex 提示登录，登录链接可能出现在更早的终端输出里。可用右侧按钮快速滚回去查看。",
  "aiApps.codexScrollTop": "滚到登录提示",
  "aiApps.paused": "已暂停",
